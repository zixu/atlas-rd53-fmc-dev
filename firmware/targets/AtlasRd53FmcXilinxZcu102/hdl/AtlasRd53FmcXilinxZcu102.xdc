...
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[6] fmcHpc0LaN[6] }];   # DATA[0][0] BANK66:(AC2/AC1)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[7] fmcHpc0LaN[7] }];   # DATA[0][1] BANK66:(U5/U4)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[8] fmcHpc0LaN[8] }];   # DATA[0][2] BANK66:(V4/V3)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[9] fmcHpc0LaN[9] }];   # DATA[0][3] BANK66:(W2/W1)

set_property -dict { IOSTANDARD LVDS } [get_ports { fmcHpc0LaP[10] fmcHpc0LaN[10] }]; #  CMD[1] BANK66:(W5/W4)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[11] fmcHpc0LaN[11] }]; # DATA[1][0] BANK66:(AB6/AB5)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[12] fmcHpc0LaN[12] }]; # DATA[1][1] BANK66:(W7/W6)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[13] fmcHpc0LaN[13] }]; # DATA[1][2] BANK66:(AB8/AC8)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[14] fmcHpc0LaN[14] }]; # DATA[1][3] BANK66:(AC7/AC6)

set_property -dict { IOSTANDARD LVDS } [get_ports { fmcHpc0LaP[15] fmcHpc0LaN[15] }]; #  CMD[2] BANK66:(Y10/Y9)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[16] fmcHpc0LaN[16] }]; # DATA[2][0] BANK66:(Y12/AA12)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[17] fmcHpc0LaN[17] }]; # DATA[2][1] BANK67:(P11/N11)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[18] fmcHpc0LaN[18] }]; # DATA[2][2] BANK67:(N9/N8)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[19] fmcHpc0LaN[19] }]; # DATA[2][3] BANK67:(L13/K13)

set_property -dict { IOSTANDARD LVDS } [get_ports { fmcHpc0LaP[20] fmcHpc0LaN[20] }]; #  CMD[3] BANK67:(N13/M13)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[21] fmcHpc0LaN[21] }]; # DATA[3][0] BANK67:(P12/N12)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[22] fmcHpc0LaN[22] }]; # DATA[3][1] BANK67:(M15/M14)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[23] fmcHpc0LaN[23] }]; # DATA[3][2] BANK67:(L16/K16)
set_property -dict { IOSTANDARD DIFF_HSTL_I_18 OFFCHIP_TERM NONE } [get_ports { fmcHpc0LaP[24] fmcHpc0LaN[24] }]; # DATA[3][3] BANK67:(L12/K12)
